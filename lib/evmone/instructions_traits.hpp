...
constexpr inline std::array<Traits, 256> traits = []() noexcept {
    ...
    table[OP_STOP] = {"STOP", 0, 0, 0, true, EVMC_FRONTIER};
    table[OP_ADD] = {"ADD", 2, -1, 0, false, EVMC_FRONTIER};
    table[OP_MUL] = {"MUL", 2, -1, 0, false, EVMC_FRONTIER};
    table[OP_SUB] = {"SUB", 2, -1, 0, false, EVMC_FRONTIER};
    table[OP_DIV] = {"DIV", 2, -1, 0, false, EVMC_FRONTIER};
    table[OP_SDIV] = {"SDIV", 2, -1, 0, false, EVMC_FRONTIER};
    table[OP_MOD] = {"MOD", 2, -1, 0, false, EVMC_FRONTIER};
    table[OP_SMOD] = {"SMOD", 2, -1, 0, false, EVMC_FRONTIER};
    table[OP_ADDMOD] = {"ADDMOD", 3, -2, 0, false, EVMC_FRONTIER};
    table[OP_MULMOD] = {"MULMOD", 3, -2, 0, false, EVMC_FRONTIER};
    table[OP_EXP] = {"EXP", 2, -1, 0, false, EVMC_FRONTIER};
    table[OP_SIGNEXTEND] = {"SIGNEXTEND", 2, -1, 0, false, EVMC_FRONTIER};

    table[OP_LT] = {"LT", 2, -1, 0, false, EVMC_FRONTIER};
    table[OP_GT] = {"GT", 2, -1, 0, false, EVMC_FRONTIER};
    table[OP_SLT] = {"SLT", 2, -1, 0, false, EVMC_FRONTIER};
    table[OP_SGT] = {"SGT", 2, -1, 0, false, EVMC_FRONTIER};
    table[OP_EQ] = {"EQ", 2, -1, 0, false, EVMC_FRONTIER};
    table[OP_ISZERO] = {"ISZERO", 1, 0, 0, false, EVMC_FRONTIER};
    table[OP_AND] = {"AND", 2, -1, 0, false, EVMC_FRONTIER};
    table[OP_OR] = {"OR", 2, -1, 0, false, EVMC_FRONTIER};
    table[OP_XOR] = {"XOR", 2, -1, 0, false, EVMC_FRONTIER};
    table[OP_NOT] = {"NOT", 1, 0, 0, false, EVMC_FRONTIER};
    table[OP_BYTE] = {"BYTE", 2, -1, 0, false, EVMC_FRONTIER};
    table[OP_SHL] = {"SHL", 2, -1, 0, false, EVMC_CONSTANTINOPLE};
    table[OP_SHR] = {"SHR", 2, -1, 0, false, EVMC_CONSTANTINOPLE};
    table[OP_SAR] = {"SAR", 2, -1, 0, false, EVMC_CONSTANTINOPLE};

    table[OP_KECCAK256] = {"KECCAK256", 2, -1, 0, false, EVMC_FRONTIER};

    table[OP_ADDRESS] = {"ADDRESS", 0, 1, 0, false, EVMC_FRONTIER};
    table[OP_BALANCE] = {"BALANCE", 1, 0, 0, false, EVMC_FRONTIER};
    table[OP_ORIGIN] = {"ORIGIN", 0, 1, 0, false, EVMC_FRONTIER};
    table[OP_CALLER] = {"CALLER", 0, 1, 0, false, EVMC_FRONTIER};
    table[OP_CALLVALUE] = {"CALLVALUE", 0, 1, 0, false, EVMC_FRONTIER};
    table[OP_CALLDATALOAD] = {"CALLDATALOAD", 1, 0, 0, false, EVMC_FRONTIER};
    table[OP_CALLDATASIZE] = {"CALLDATASIZE", 0, 1, 0, false, EVMC_FRONTIER};
    table[OP_CALLDATACOPY] = {"CALLDATACOPY", 3, -3, 0, false, EVMC_FRONTIER};
    table[OP_CODESIZE] = {"CODESIZE", 0, 1, 0, false, EVMC_FRONTIER};
    table[OP_CODECOPY] = {"CODECOPY", 3, -3, 0, false, EVMC_FRONTIER};
    table[OP_GASPRICE] = {"GASPRICE", 0, 1, 0, false, EVMC_FRONTIER};
    table[OP_EXTCODESIZE] = {"EXTCODESIZE", 1, 0, 0, false, EVMC_FRONTIER};
    table[OP_EXTCODECOPY] = {"EXTCODECOPY", 4, -4, 0, false, EVMC_FRONTIER};
    table[OP_RETURNDATASIZE] = {"RETURNDATASIZE", 0, 1, 0, false, EVMC_BYZANTIUM};
    table[OP_RETURNDATACOPY] = {"RETURNDATACOPY", 3, -3, 0, false, EVMC_BYZANTIUM};
    table[OP_EXTCODEHASH] = {"EXTCODEHASH", 1, 0, 0, false, EVMC_CONSTANTINOPLE};

    table[OP_BLOCKHASH] = {"BLOCKHASH", 1, 0, 0, false, EVMC_FRONTIER};
    ...
    table[OP_BASEFEE] = {"BASEFEE", 0, 1, 0, false, EVMC_LONDON};

    table[OP_POP] = {"POP", 1, -1, 0, false, EVMC_FRONTIER};
    table[OP_MLOAD] = {"MLOAD", 1, 0, 0, false, EVMC_FRONTIER};
    table[OP_MSTORE] = {"MSTORE", 2, -2, 0, false, EVMC_FRONTIER};
    table[OP_MSTORE8] = {"MSTORE8", 2, -2, 0, false, EVMC_FRONTIER};
    table[OP_SLOAD] = {"SLOAD", 1, 0, 0, false, EVMC_FRONTIER};
    table[OP_SSTORE] = {"SSTORE", 2, -2, 0, false, EVMC_FRONTIER};
    table[OP_JUMP] = {"JUMP", 1, -1, 0, false, EVMC_FRONTIER};
    table[OP_JUMPI] = {"JUMPI", 2, -2, 0, false, EVMC_FRONTIER};
    table[OP_PC] = {"PC", 0, 1, 0, false, EVMC_FRONTIER};
    ...
    table[OP_PUSH1] = {"PUSH1", 0, 1, 1, false, EVMC_FRONTIER};
    table[OP_PUSH2] = {"PUSH2", 0, 1, 2, false, EVMC_FRONTIER};
    table[OP_PUSH3] = {"PUSH3", 0, 1, 3, false, EVMC_FRONTIER};
    table[OP_PUSH4] = {"PUSH4", 0, 1, 4, false, EVMC_FRONTIER};
    table[OP_PUSH5] = {"PUSH5", 0, 1, 5, false, EVMC_FRONTIER};
    table[OP_PUSH6] = {"PUSH6", 0, 1, 6, false, EVMC_FRONTIER};
    table[OP_PUSH7] = {"PUSH7", 0, 1, 7, false, EVMC_FRONTIER};
    table[OP_PUSH8] = {"PUSH8", 0, 1, 8, false, EVMC_FRONTIER};
    table[OP_PUSH9] = {"PUSH9", 0, 1, 9, false, EVMC_FRONTIER};
    table[OP_PUSH10] = {"PUSH10", 0, 1, 10, false, EVMC_FRONTIER};
    table[OP_PUSH11] = {"PUSH11", 0, 1, 11, false, EVMC_FRONTIER};
    table[OP_PUSH12] = {"PUSH12", 0, 1, 12, false, EVMC_FRONTIER};
    table[OP_PUSH13] = {"PUSH13", 0, 1, 13, false, EVMC_FRONTIER};
    table[OP_PUSH14] = {"PUSH14", 0, 1, 14, false, EVMC_FRONTIER};
    table[OP_PUSH15] = {"PUSH15", 0, 1, 15, false, EVMC_FRONTIER};
    table[OP_PUSH16] = {"PUSH16", 0, 1, 16, false, EVMC_FRONTIER};
    table[OP_PUSH17] = {"PUSH17", 0, 1, 17, false, EVMC_FRONTIER};
    table[OP_PUSH18] = {"PUSH18", 0, 1, 18, false, EVMC_FRONTIER};
    table[OP_PUSH19] = {"PUSH19", 0, 1, 19, false, EVMC_FRONTIER};
    table[OP_PUSH20] = {"PUSH20", 0, 1, 20, false, EVMC_FRONTIER};
    table[OP_PUSH21] = {"PUSH21", 0, 1, 21, false, EVMC_FRONTIER};
    table[OP_PUSH22] = {"PUSH22", 0, 1, 22, false, EVMC_FRONTIER};
    table[OP_PUSH23] = {"PUSH23", 0, 1, 23, false, EVMC_FRONTIER};
    table[OP_PUSH24] = {"PUSH24", 0, 1, 24, false, EVMC_FRONTIER};
    table[OP_PUSH25] = {"PUSH25", 0, 1, 25, false, EVMC_FRONTIER};
    table[OP_PUSH26] = {"PUSH26", 0, 1, 26, false, EVMC_FRONTIER};
    table[OP_PUSH27] = {"PUSH27", 0, 1, 27, false, EVMC_FRONTIER};
    table[OP_PUSH28] = {"PUSH28", 0, 1, 28, false, EVMC_FRONTIER};
    table[OP_PUSH29] = {"PUSH29", 0, 1, 29, false, EVMC_FRONTIER};
    table[OP_PUSH30] = {"PUSH30", 0, 1, 30, false, EVMC_FRONTIER};
    table[OP_PUSH31] = {"PUSH31", 0, 1, 31, false, EVMC_FRONTIER};
    table[OP_PUSH32] = {"PUSH32", 0, 1, 32, false, EVMC_FRONTIER};

    table[OP_DUP1] = {"DUP1", 1, 1, 0, false, EVMC_FRONTIER};
    table[OP_DUP2] = {"DUP2", 2, 1, 0, false, EVMC_FRONTIER};
    table[OP_DUP3] = {"DUP3", 3, 1, 0, false, EVMC_FRONTIER};
    table[OP_DUP4] = {"DUP4", 4, 1, 0, false, EVMC_FRONTIER};
    table[OP_DUP5] = {"DUP5", 5, 1, 0, false, EVMC_FRONTIER};
    table[OP_DUP6] = {"DUP6", 6, 1, 0, false, EVMC_FRONTIER};
    table[OP_DUP7] = {"DUP7", 7, 1, 0, false, EVMC_FRONTIER};
    table[OP_DUP8] = {"DUP8", 8, 1, 0, false, EVMC_FRONTIER};
    table[OP_DUP9] = {"DUP9", 9, 1, 0, false, EVMC_FRONTIER};
    table[OP_DUP10] = {"DUP10", 10, 1, 0, false, EVMC_FRONTIER};
    table[OP_DUP11] = {"DUP11", 11, 1, 0, false, EVMC_FRONTIER};
    table[OP_DUP12] = {"DUP12", 12, 1, 0, false, EVMC_FRONTIER};
    table[OP_DUP13] = {"DUP13", 13, 1, 0, false, EVMC_FRONTIER};
    table[OP_DUP14] = {"DUP14", 14, 1, 0, false, EVMC_FRONTIER};
    table[OP_DUP15] = {"DUP15", 15, 1, 0, false, EVMC_FRONTIER};
    table[OP_DUP16] = {"DUP16", 16, 1, 0, false, EVMC_FRONTIER};

    table[OP_SWAP1] = {"SWAP1", 2, 0, 0, false, EVMC_FRONTIER};
    table[OP_SWAP2] = {"SWAP2", 3, 0, 0, false, EVMC_FRONTIER};
    table[OP_SWAP3] = {"SWAP3", 4, 0, 0, false, EVMC_FRONTIER};
    table[OP_SWAP4] = {"SWAP4", 5, 0, 0, false, EVMC_FRONTIER};
    table[OP_SWAP5] = {"SWAP5", 6, 0, 0, false, EVMC_FRONTIER};
    table[OP_SWAP6] = {"SWAP6", 7, 0, 0, false, EVMC_FRONTIER};
    table[OP_SWAP7] = {"SWAP7", 8, 0, 0, false, EVMC_FRONTIER};
    table[OP_SWAP8] = {"SWAP8", 9, 0, 0, false, EVMC_FRONTIER};
    table[OP_SWAP9] = {"SWAP9", 10, 0, 0, false, EVMC_FRONTIER};
    table[OP_SWAP10] = {"SWAP10", 11, 0, 0, false, EVMC_FRONTIER};
    table[OP_SWAP11] = {"SWAP11", 12, 0, 0, false, EVMC_FRONTIER};
    table[OP_SWAP12] = {"SWAP12", 13, 0, 0, false, EVMC_FRONTIER};
    table[OP_SWAP13] = {"SWAP13", 14, 0, 0, false, EVMC_FRONTIER};
    table[OP_SWAP14] = {"SWAP14", 15, 0, 0, false, EVMC_FRONTIER};
    table[OP_SWAP15] = {"SWAP15", 16, 0, 0, false, EVMC_FRONTIER};
    table[OP_SWAP16] = {"SWAP16", 17, 0, 0, false, EVMC_FRONTIER};

    table[OP_LOG0] = {"LOG0", 2, -2, 0, false, EVMC_FRONTIER};
    table[OP_LOG1] = {"LOG1", 3, -3, 0, false, EVMC_FRONTIER};
    table[OP_LOG2] = {"LOG2", 4, -4, 0, false, EVMC_FRONTIER};
    table[OP_LOG3] = {"LOG3", 5, -5, 0, false, EVMC_FRONTIER};
    table[OP_LOG4] = {"LOG4", 6, -6, 0, false, EVMC_FRONTIER};

    table[OP_CREATE] = {"CREATE", 3, -2, 0, false, EVMC_FRONTIER};
    table[OP_CALL] = {"CALL", 7, -6, 0, false, EVMC_FRONTIER};
    table[OP_CALLCODE] = {"CALLCODE", 7, -6, 0, false, EVMC_FRONTIER};
    table[OP_RETURN] = {"RETURN", 2, -2, 0, true, EVMC_FRONTIER};
    table[OP_DELEGATECALL] = {"DELEGATECALL", 6, -5, 0, false, EVMC_HOMESTEAD};
    table[OP_CREATE2] = {"CREATE2", 4, -3, 0, false, EVMC_CONSTANTINOPLE};
    table[OP_STATICCALL] = {"STATICCALL", 6, -5, 0, false, EVMC_BYZANTIUM};
    table[OP_REVERT] = {"REVERT", 2, -2, 0, true, EVMC_BYZANTIUM};
    table[OP_INVALID] = {"INVALID", 0, 0, 0, true, EVMC_FRONTIER};
    table[OP_SELFDESTRUCT] = {"SELFDESTRUCT", 1, -1, 0, true, EVMC_FRONTIER};
